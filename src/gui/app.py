...
class Janela(QMainWindow):
    ...
    def mostrar_remover(self):
        ...
        # Adiciona os widgets do formulário no mesmo layout
        layout.addWidget(self.texto_form)
        self.texto_form.setText("Preencha para remover um contato: ")
    ...
    def mostrar_busca(self):
        ...
        texto = QLabel("Digite qualquer termo para buscar um contato (nome, número, relação ou email):")
        texto.setStyleSheet("font-size: 18px; font-weight: bold;")
        layout.addWidget(texto)
    ...
    def mostrar_alterar(self):
        ...
        # Adiciona os widgets do formulário no mesmo layout
        texto = QLabel("Preencha para alterar um contato (Campos vazios não serão alterados):")
        texto.setStyleSheet("font-size: 18px; font-weight: bold;")
        layout.addWidget(texto)
